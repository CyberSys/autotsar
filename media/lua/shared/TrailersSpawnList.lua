...
VehicleZoneDistribution.parkingstall.vehicles["Base.SecondTrailer"] = {index = -1, spawnChance = 5};
...
VehicleZoneDistribution.trailerpark.vehicles["Base.SecondTrailer"] = {index = -1, spawnChance = 5};
...
VehicleZoneDistribution.bad.vehicles["Base.SecondTrailer"] = {index = -1, spawnChance = 5};
...
VehicleZoneDistribution.medium.vehicles["Base.SecondTrailer"] = {index = -1, spawnChance = 5};
...
VehicleZoneDistribution.junkyard.vehicles["Base.FirstTrailer"] = {index = -1, spawnChance = 10};
...
VehicleZoneDistribution.farm.vehicles["Base.FirstTrailer"] = {index = -1, spawnChance = 10};
